...
/**
 * Thrown when a problem occurs with the type of a Tag.
...
public class NBTTagException extends Exception {
    ...
    /**
     * Creates an exception to represent a problem with the tag's ID or
     * overall format.
     * @param message the detail message. The detail message is saved for
     * later retrieval by the {@link java.lang.Exeption#getMessage()} method.
     */
    public NBTTagException(String message) {
        super(message);
    }
}
